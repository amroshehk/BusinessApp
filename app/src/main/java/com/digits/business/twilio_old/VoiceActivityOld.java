...
public class VoiceActivityOld extends AppCompatActivity {
    ...
    private SoundPoolManagerOld soundPoolManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundPoolManager = SoundPoolManagerOld.getInstance(this);
    ...
    private void resetUI() {
        callActionFab.show();
        muteActionFab.setImageDrawable(ContextCompat.getDrawable(VoiceActivityOld.this, R.drawable.ic_mic_white_off_24dp));
        muteActionFab.hide();
    ...
    public void onBackPressed() {
        ...
        Intent mainIntent = new Intent(VoiceActivityOld.this, MainActivity.class);
        ...
        if (intent != null && intent.getAction() != null) {
            if (intent.getAction().equals(ACTION_INCOMING_CALL)) {
                ...
                if (activeCallInvite != null && (activeCallInvite.getState() == CallInvite.State.PENDING)) {
                    ...
                    alertDialog = createIncomingCallDialog(VoiceActivityOld.this,
                            activeCallInvite,
    ...
    private DialogInterface.OnClickListener callClickListener() {
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                activeCall = Voice.call(VoiceActivityOld.this, accessToken, twiMLParams, callListener);
                setCallUI();
                alertDialog.dismiss();
            }
        };
        ...
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (activeCallInvite != null) {
                    activeCallInvite.reject(VoiceActivityOld.this);
    ...
    private View.OnClickListener callActionFabClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                alertDialog = createCallDialog(callClickListener(), cancelCallClickListener(), VoiceActivityOld.this);
                alertDialog.show();
            }
        };
    }
        ...
        Ion.with(this).load(TWILIO_ACCESS_TOKEN_SERVER_URL + "?identity=" + identity).asString().setCallback(new FutureCallback<String>() {
            ...
            public void onCompleted(Exception e, String accessToken) {
                if (e == null) {
                    ...
                    VoiceActivityOld.this.accessToken = accessToken;
