...
public class SoundPoolManagerOld {
    ...
    private static SoundPoolManagerOld instance;

    private SoundPoolManagerOld(Context context) {
    ...
    public static SoundPoolManagerOld getInstance(Context context) {
        if (instance == null) {
            instance = new SoundPoolManagerOld(context);
        }
        return instance;
    }
