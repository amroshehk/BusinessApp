...
public class RecyclerNumberLogCardAdapter extends RecyclerView.Adapter<RecyclerNumberLogCardAdapter.ViewHolder> {
    ...
    public RecyclerNumberLogCardAdapter(ArrayList<Log> logs, Context context, Activity mActivity) {
        this.logs = logs;
