...
public class Tab3IncomingCallFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview= inflater.inflate(R.layout.tab3_incoming_call_fragment, container, false);
        ...
        logs=dbHelper.getAllLogByEmailAndType(email,1);
        ...
        clear_log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dbHelper.deleteAllLogByEmailAndType(email,1);
                logs.clear();
