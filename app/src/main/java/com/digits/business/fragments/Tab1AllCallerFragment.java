...
public class Tab1AllCallerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview= inflater.inflate(R.layout.tab1_all_caller_fragment, container, false);
        ...
        logs=dbHelper.getAllLogByEmail(email);
        ...
        clear_log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dbHelper.deleteAllLogByEmail(email);
                logs.clear();
