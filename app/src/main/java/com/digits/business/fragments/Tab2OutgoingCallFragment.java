...
public class Tab2OutgoingCallFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview= inflater.inflate(R.layout.tab2_outgoing_call_fragment, container, false);
        ...
        logs=dbHelper.getAllLogByEmailAndType(email,2);
        ...
        clear_log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dbHelper.deleteAllLogByEmailAndType(email,2);
                logs.clear();
