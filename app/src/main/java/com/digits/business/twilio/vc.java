...
public class vc extends AppCompatActivity {
    ...
    //private static String identity = "ajitk";
    /*
    ...
    private void resetUI() {
        callActionFab.show();
        muteActionFab.setImageDrawable(ContextCompat.getDrawable(vc.this, R.drawable.ic_mic_white_24dp));
        muteActionFab.hide();
        ...
        if (intent != null && intent.getAction() != null) {
            if (intent.getAction().equals(ACTION_INCOMING_CALL)) {
                ...
                if (activeCallInvite != null && (activeCallInvite.getState() == CallInvite.State.PENDING)) {
                    ...
                    alertDialog = createIncomingCallDialog(vc.this,
                            activeCallInvite,
    ...
    private DialogInterface.OnClickListener callClickListener() {
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                twiMLParams.put("to", toString());
                activeCall = Voice.call(vc.this, accessToken, twiMLParams, callListener);
                setCallUI();
                alertDialog.dismiss();
            }
        };
        ...
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (activeCallInvite != null) {
                    activeCallInvite.reject(vc.this);
    ...
    private View.OnClickListener callActionFabClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                alertDialog = createCallDialog(callClickListener(), cancelCallClickListener(), vc.this);
                alertDialog.show();
            }
        };
    }
    ...
    private void mute() {
        if (activeCall != null) {
            ...
            if (mute) {
                muteActionFab.setImageDrawable(ContextCompat.getDrawable(vc.this, R.drawable.ic_mic_white_off_24dp));
            } else {
                muteActionFab.setImageDrawable(ContextCompat.getDrawable(vc.this, R.drawable.ic_mic_white_24dp));
            }
        }
        ...
        Ion.with(this).load(TWILIO_ACCESS_TOKEN_SERVER_URL + "?identity=" + identity).asString().setCallback(new FutureCallback<String>() {
            ...
            public void onCompleted(Exception e, String accessToken) {
                if (e == null) {
                    ...
                    vc.this.accessToken = accessToken;
